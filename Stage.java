...
public class Stage {
    ...
    // M̩thode pour ajouter un stage
    ...
    // M̩thode pour modifier un stage
    ...
    // M̩thode pour supprimer un stage
    ...
    // M̩thode pour afficher tous les stages
    public static void afficherTousLesStages(Connection connexion) throws SQLException {
        ...
        try (PreparedStatement statement = connexion.prepareStatement(sql)) {
            ...
            while (resultSet.next()) {
                ...
                System.out.printf("ID: %d, Nom de la structure: %s, Sujet du stage: %s, Mois de d̩but du stage: %s, Dur̩e du stage: %d, Promotion de l'̩tudiant: %s%n", id, nom_structure, sujet_stage, mois_debut_stage, duree_stage, promotion_etudiant);
            }
        }
    }
}
